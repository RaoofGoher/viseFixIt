...
const CompanyCulture = () => {
  return (
    <section className="py-16 px-6 sm:px-12 lg:px-20  text-secondaryColor-dark">
      ...
      <p className="text-center max-w-3xl mx-auto text-dark mb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 ">
        ...
        {/* Value 2: Innovation */}
        <div className="flex flex-col group items-center p-6 bg-white shadow-lg rounded-lg hover:bg-primaryColor hover:text-white transition">
