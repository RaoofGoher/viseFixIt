      ...
      <div className="space-y-6 max-w-3xl mx-auto">
        ...
        <details className="group border border-gray-600 rounded-lg p-6 bg-white text-primaryColor hover:bg-primaryColor hover:text-white transition">
          <summary className="font-semibold text-lg flex items-center">
            <FaQuestionCircle className="mr-2 text-primaryColor group-hover:text-secondaryColor" />
        ...
        <details className=" group  border border-gray-600 rounded-lg p-6 bg-white text-primaryColor hover:bg-primaryColor hover:text-white transition">
          <summary className="font-semibold text-lg flex items-center">
            <FaRegClock className="mr-2 text-primaryColor group-hover:text-secondaryColor " />
            Can I work remotely?
          </summary>
          <p className="mt-2 text-gray-500">
        ...
        <details className="group border border-gray-600 rounded-lg p-6 bg-white text-primaryColor hover:bg-primaryColor hover:text-white transition">
          <summary className="font-semibold text-lg flex items-center">
            <FaTools className="mr-2 text-primaryColor group-hover:text-secondaryColor" />
        ...
        <details className="group  border border-gray-600 rounded-lg p-6 bg-white text-primaryColor hover:bg-primaryColor hover:text-white transition">
          <summary className="font-semibold text-lg flex items-center">
            <FaTruck className="mr-2 text-primaryColor group-hover:text-secondaryColor" />
        ...
        <details className=" group border border-gray-600 rounded-lg p-6 bg-white text-primaryColor hover:bg-primaryColor hover:text-white transition">
          <summary className="font-semibold text-lg flex items-center">
            <FaHardHat className="mr-2 text-primaryColor group-hover:text-secondaryColor" />
