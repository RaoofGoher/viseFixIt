    ...
    <section className="py-16 px-6 sm:px-12 lg:px-20 bg-lightColor3 text-secondaryColor-dark">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
        ...
        <div className="group flex flex-col items-center p-6 bg-white shadow-lg rounded-lg hover:bg-primaryColor hover:text-white transition">
          <FaTools className="text-4xl mb-4 text-primaryColor group-hover:text-secondaryColor" />
        ...
        <div className=" group flex flex-col items-center p-6 bg-white shadow-lg rounded-lg hover:bg-primaryColor hover:text-white transition">
          <FaRegClock className="text-4xl mb-4 text-primaryColor group-hover:text-secondaryColor" />
        ...
        <div className=" group flex flex-col items-center p-6 bg-white shadow-lg rounded-lg hover:bg-primaryColor hover:text-white transition">
          <FaHardHat className="text-4xl mb-4 text-primaryColor group-hover:text-secondaryColor" />
        ...
        <div className="group flex flex-col items-center p-6 bg-white shadow-lg rounded-lg hover:bg-primaryColor hover:text-white transition">
          <FaTruck className="text-4xl mb-4 text-primaryColor group-hover:text-secondaryColor" />
        ...
        <div className=" group flex flex-col items-center p-6 bg-white shadow-lg rounded-lg hover:bg-primaryColor hover:text-white transition">
          <FaWrench className="text-4xl mb-4 text-primaryColor group-hover:text-secondaryColor" />
        ...
        <div className=" group flex flex-col items-center p-6 bg-white shadow-lg rounded-lg hover:bg-primaryColor hover:text-white transition">
          <FaHome className="text-4xl mb-4 text-primaryColor group-hover:text-secondaryColor" />
